...
def circle_contours(image, contours):
    # Bounding ellipse
...
def find_strawberry(image):
    ...
    contours, mask_strawberries = find_contours(mask_clean)
    ...
    circled = circle_contours(overlay, contours)
    show(circled)
